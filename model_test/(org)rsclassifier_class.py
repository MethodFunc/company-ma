...
class Classifier:
    def __init__(self, MODEL_PATH, PATH, CATEGORIES, SAMPLING_RATIO, ROI, SHOW=None, MOVE=None):
        ...
        self.ROI = ROI
        # self.ROI = [(5, 0), (6, 0), (7, 0), (1, 1), (2, 1), (3, 1), (1, 2), (2, 2), (3, 2),  (4, 2), (5, 2), (6, 2),  (9, 3), (9, 4), (9, 5)]
        # self.ROI = [(1, 10), (2, 8), (2, 9), (2, 10), (3, 7), (3, 8), (3, 9), (4, 7), (4, 10), (4, 11), (5, 9),
        #              (5, 10), (5, 11), (6, 8), (6, 9), (6, 10)]
        self.SHOW = SHOW
        self.MOVE = MOVE
        ...
        for imgs in images:
            ...
            if self.SHOW is None:
                ...
                print(f'총 이미지 : {full_image}, 진행 갯수 : {ing_count}, 진행율 : {ing_percent:.2f}% - {CATEGORIES[0]} : {dry_day:.2f}%, {CATEGORIES[1]} : {dry_night:.2f}%'
                      f', {CATEGORIES[2]} : {wet_day:.2f}%, {CATEGORIES[3]} : {wet_night:.2f}%'\
                        
                      f', filename : {filename[0]}', flush=True)

                # {CATEGORIES[2]} : {wet_day:.2f}%,  {CATEGORIES[3]} : {wet_night:.2f}%, {CATEGORIES[4]} : {etc:.2f}%, {CATEGORIES[5]} : {etc2:.2f}%
...
if __name__ == '__main__':
    ...
    # - Change it-
    model_path = r'D:\Harry\000.DataAnalysis\004.Model\53R\road\cp_20201226220240.tf'
    # model_path = r'D:\Harry\000.DataAnalysis\004.Model\53R\weather\cp_20210216144351.tf'
    # model_path = r'D:\Harry\000.DataAnalysis\004.Model\2model_test\ns\cp_20210215174145_bid_lstm.tf'
    # folder_path = r'F:\MK-SD53R\2021-02-04\201'
    # folder_path = r'F:\MK-SD53R\2021-01-26\202'
    # folder_path = r'C:\Users\user\Pictures\53R2021-01-12'
    folder_path = r'F:\MK-SD53R\ing\2021-02-05\201'
    SAMPLING_RATIO = 100
    CATEGORIES = ['dry_day', 'dry_night', 'wet_day', 'wet_night']
    # CATEGORIES = ['normal', 'snow']
    # CATEGORIES = ['normal', 'fog', 'snow']
    # SHOW_CATEGORIES = 4
    ROI = setting_roi('53R_201')  # 33A_201, 33A_201_old, 33A_201_fusion, 33C_201, 33C_201_fusion, 53R_201, 53R_202  || 201 = Road, 202 = Weather
    #
