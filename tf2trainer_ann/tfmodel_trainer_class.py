...
class Model_train:
    ...
    def create_model(self):
        ...
        model.add(tf.keras.layers.Dense(64, activation='relu', kernel_initializer='he_uniform', input_dim= 24))
...
if __name__ == '__main__':
    LOAD_MODEL = None
    # ---------- Change it -------------------------------
    SOURCE_PATH = r'D:\Harry\000.DataAnalysis\TEST'  # Change Train image directory
    CATEGORIES = ['normal_day', 'normal_night', 'fog', 'fog_night',  'snow_day', 'snow_night']  # Change
    ...
    SAMPLE_NUMBER = 50  # Less in Image Folder
    EPOCHS = 100
    BATCH_SIZE = 128
